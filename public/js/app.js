...
/////////////////////////// Wizard Form ////////////////////////
    ...
    var settinghtml = `<div id="settings" class="">
            ...
            <div class="sidbarchat p-3">
                ...
                <li class="gradient-img-block m-2 list-inline-item float-left color2" data-primary="#396e94" ></li> 
                <li class="gradient-img-block m-2 list-inline-item float-left color2" data-primary="#49424a"  ></li>
                <li class="gradient-img-block m-2 list-inline-item float-left color2" data-primary="#eb6709" ></li>
                <li class="gradient-img-block m-2 list-inline-item float-left color2" data-primary="#bb416b" ></li>
                <li class="gradient-img-block m-2 list-inline-item float-left color2" data-primary="#17b3a3" ></li>
                <li class="gradient-img-block m-2 list-inline-item float-left color2" data-primary="#4e7184" ></li>
                <li class="gradient-img-block m-2 list-inline-item float-left color2" data-primary="#11d2d7" ></li>
                <li class="gradient-img-block m-2 list-inline-item float-left color2" data-primary="#da88d1" ></li>
                </ul>
                </div>
                <br/><br/>
                <hr class="float-left w-100"/>
...
////////////////////////////// TEMPLATE Color /////////////////////////
    $(".gradient-img-block").on('click', function () {
        ...
        var imageUrl = "/static/images/" + $(this).data('img');
